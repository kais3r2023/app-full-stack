...
export default function QRLogo() {
  return (
    <Svg width={35} height={35} viewBox="0 0 24 24" fill="none">
      ...
      />
      <Rect x={6} y={10} width={2} height={2} rx={0.5} fill="#000000" />
      <Path
        ...
        fill="#000000"
      />
      <Rect x={8} y={12} width={4} height={2} rx={0.5} fill="#000000" />
      <Rect x={18} y={10} width={4} height={2} rx={0.5} fill="#000000" />
      <Rect x={12} y={18} width={4} height={2} rx={0.5} fill="#000000" />
      <Rect x={10} y={16} width={2} height={2} rx={0.5} fill="#000000" />
      <Path
